...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    private IEnumerator GameWon()
    {
        ...
        {
            rankText = "TU PUNTAJE ENTRO EN EL RANKING" + rank.ToString("#0") + "EN EL TOP" + Settings.numberOfHighScoresToSave.ToString("#0");
        ...
        yield return StartCoroutine(DisplayMessageRoutine("BIEN HECHO " + GameResources.Instance.currentPlayer.playerName + "! HAS DERROTADO LA PESADILLA", Color.white, 3f));

        yield return StartCoroutine(DisplayMessageRoutine("TU PUNTAJE:" + gameScore.ToString("###,###0") + "\n\n" + rankText, Color.white, 4f));
        
        yield return StartCoroutine(DisplayMessageRoutine("PRESIONA 'VOLVER' PARA REINICIAR EL JUEGO", Color.white, 0f));
    ...
    private IEnumerator GameLost()
    {
        ...
        yield return StartCoroutine(DisplayMessageRoutine("MALA SUERTE " + GameResources.Instance.currentPlayer.playerName + "! NO HAS DERROTADO TU PESADILLA", Color.white, 2f));

        yield return StartCoroutine(DisplayMessageRoutine("TU PUNTAJE: " + gameScore.ToString("###,###0") + "\n\n" + rankText, Color.white, 4f));
        
        yield return StartCoroutine(DisplayMessageRoutine("PRESIONA 'DEVOLVE' PARA REINICIAR EL JUEGO", Color.white, 0f));
