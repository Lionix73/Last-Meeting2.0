...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    private IEnumerator DisplayDungeonLevelText()
    {
        ...
        string messageText = "NIVEL " + (currentDungeonLevelListIndex + 1).ToString() + "\n\n" + dungeonLevelList[currentDungeonLevelListIndex].levelName.ToUpper();
    ...
    private IEnumerator BossStage()
    {
        ...
        yield return StartCoroutine(DisplayMessageRoutine("BIEN HECHO  " + GameResources.Instance.currentPlayer.playerName + "!  HAS SOBREVIVIDO...UNA PARTE\n\nAHORA BUSCA Y DERROTA AL JEFE... BUENA SUERTE!", Color.white, 5f));
    ...
    private IEnumerator GameWon()
    {
        ...
        {
            rankText = "TU PUNTAJE ESTA EN EL RANK " + rank.ToString("#0") + " EN EL TOP " + Settings.numberOfHighScoresToSave.ToString("#0");
        ...
        {
            rankText = "TU PUNTAJE NO ESTA EN EL TOP " + Settings.numberOfHighScoresToSave.ToString("#0");
        }
        ...
        // Display game won
        yield return StartCoroutine(DisplayMessageRoutine("BIEN HECHO " + GameResources.Instance.currentPlayer.playerName + "! DERROTASTE LA PESADILLA", Color.white, 3f));
    ...
    private IEnumerator GameLost()
    {
        ...
        if (rank > 0 && rank <= Settings.numberOfHighScoresToSave)
        {
            ...
            // Update scores
            HighScoreManager.Instance.AddScore(new Score() { playerName = name, levelDescription = "NIVEL " + (currentDungeonLevelListIndex + 1).ToString() + " - " + GetCurrentDungeonLevel().levelName.ToUpper(), playerScore = gameScore }, rank);
        }
        else
        {
            rankText = "TU PUNTAJE NO ESTA EN EL TOP " + Settings.numberOfHighScoresToSave.ToString("#0");
        ...
        // Display game lost
        yield return StartCoroutine(DisplayMessageRoutine("MALA SUERTE " + GameResources.Instance.currentPlayer.playerName + "! LA PESADILLA TE HA CONSUMIDO", Color.white, 2f));
