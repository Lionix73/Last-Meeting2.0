...
public class WeaponStatusUI : MonoBehaviour
{
    ...
    private void UpdateActiveWeaponImage(WeaponsDetailsSO weaponsDetails)
    {
        weaponImage.sprite = weaponsDetails.weaponSprite;
    }

    private void UpdateActiveWeaponName(Weapon weapon)
    {
        weaponNameText.text = "(" + weapon.weaponListPosition + ")" + weapon.weaponsDetails.weaponName.ToUpper();
    }
    ...
    private void UpdateAmmoText(Weapon weapon)
    {
        ...
        {
            ammoRemainingText.text = "MUNICION INF";
        }
        else
        {
    ...
    private void UpdateAmmoLoadedIcons(Weapon weapon)
    {
        ...
        for (int i = 0; i < weapon.weaponClipReaminingAmmo; i++)
        {
    ...
    private IEnumerator UpdateWeaponReloadBarRoutine(Weapon currentWeapon)
    {
        ...
        {
            float barfill = currentWeapon.weaponReloadTimer / currentWeapon.weaponsDetails.weaponReloadTime;
    ...
    {
        if ((!weapon.weaponsDetails.hasInfiniteClipCapacity) && (weapon.weaponClipReaminingAmmo <= 0 || weapon.isWeaponReloading))
        {
            barImage.color = Color.red;
