...
public class HighScoreManager : SingletonMonobehaviour<HighScoreManager>
{
    ...
    private void LoadScores()
    {
        ...
        if (File.Exists(Application.persistentDataPath + " /LasMeetingHighScores.dat"))
        {
            ClearScoreList();

            FileStream file = File.OpenRead(Application.persistentDataPath + " /LasMeetingHighScores.dat");
    ...
    private void SaveScores()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + " /LasMeetingHighScores.dat");
