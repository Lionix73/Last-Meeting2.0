...
public class AStarTest : MonoBehaviour
{
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        frontTilemap = instantiatedRoom.transform.Find("Grid/Tilemap4 Front").GetComponent<Tilemap>();
    ...
    {
        Transform tilemapCloneTransform = instantiatedRoom.transform.Find("Grid/Tilemap4 Front(Clone)");
        ...
        {
            pathTilemap = instantiatedRoom.transform.Find("Grid/Tilemap4 Front(Clone)").GetComponent<Tilemap>();
