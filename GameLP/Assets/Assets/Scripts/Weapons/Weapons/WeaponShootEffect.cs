...
public class WeaponShootEffect : MonoBehaviour
{
    ...
    {
        SetShootEffectColorGradient(shootEffect.coloGradient);
        ...
        SetShootEffectVelocityOverLifeTime(shootEffect.velocityOverLifeTimeMin, shootEffect.velocityOverLiteTimeMax);
    }
