...
public class AmmoHitEffect : MonoBehaviour
{
    ...
    {
        SetHitEffectColorGradient(ammoHitEffect.coloGradient);
        ...
        SetHitEffectVelocityOverLifeTime(ammoHitEffect.velocityOverLifeTimeMin, ammoHitEffect.velocityOverLiteTimeMax);
    }
